...
func TestServer_DecodeError(t *testing.T) {
	...
	dec := func(ctx context.Context, data []byte) (int, error) { return 0, errors.New("bad data") }
...
func TestClient(t *testing.T) {
	enc := func(ctx context.Context, req int) ([]byte, error) { return json.Marshal(req) }
	dec := func(ctx context.Context, data []byte) (int, error) {
		var v int
		json.Unmarshal(data, &v)
		return v, nil
	}
	client := amqp.NewClient[int, int](enc, dec)
	ep := client.Endpoint()
